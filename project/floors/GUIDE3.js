main.floors.GUIDE3=
{
    ...
    "events": {
        ...
        "4,9": [
            {
                ...
                "false": [
                    ...
                    {
                        "type": "setValue",
                        "name": "flag:guide3FirstShopClosed",
                        "value": "true"
                    },
                    {
                        "type": "setBlock",
        ...
        "3,10": [
            {
                "type": "if",
                "condition": "(!flag:guide3FirstShopClosed)",
                "true": [
                    {
                        "type": "function",
        ...
        "6,9": [
            ...
            "\t[艾露达,N447]我再给你1000块钱，右边的商店可以购买背包格子，去买一点格子吧",
            {
                "type": "setValue",
                "name": "status:money",
                "operator": "+=",
        ...
        "8,11": [
            {
                ...
                "false": [
                    ...
                    {
                        "type": "setValue",
                        "name": "flag:guide3ExpansionShopClosed",
                        "value": "true"
                    },
                    {
                        "type": "setBlock",
        ...
        "9,10": [
            {
                "type": "if",
                "condition": "(!flag:guide3ExpansionShopClosed)",
                "true": [
                    {
                        "type": "openShop",
                        "id": "shop2",
    ...
    "afterGetItem": {
        ...
        "6,2": [{"type": "setBlock", "number": "ground", "loc": [[6, 2]]}],
        "6,3": [{"type": "setBlock", "number": "ground", "loc": [[6, 3]]}],
        "6,4": [{"type": "setBlock", "number": "ground", "loc": [[6, 4]]}],
        "6,5": [{"type": "setBlock", "number": "ground", "loc": [[6, 5]]}],
        "6,6": [{"type": "setBlock", "number": "ground", "loc": [[6, 6]]}],
        "6,7": [{"type": "setBlock", "number": "ground", "loc": [[6, 7]]}],
        "6,8": [{"type": "setBlock", "number": "ground", "loc": [[6, 8]]}]
    },
    "afterOpenDoor": {},
    "autoEvent": {},
    "cannotMove": {},
