    ...
    "events": {
        "6,10": {
            ...
            "data": [
                ...
                "\t[redKing]你敢临阵脱逃！",
                "\t[yellowKnight]哦，大王，我打不过这个勇士，不得不逃，绕了我吧？",
                "\t[redKing]你说什么？你敢再说一次！你象个胆小鬼一样逃离你负责的区域,并说出那样的话。魔塔不需要象你这样的败类，来人给我杀了。",
                {
                    "type": "setBlock",
                    "number": "whiteKing",
                    "loc": [
                ...
                "\t[redKing]虽然我刚才态度异常，但别担心在决斗时，我不会像刚才这个无用的家伙一样让手下一拥而上。我期待着与你决斗。",
                {
                    "type": "hide",
                    "loc": [
                        [
