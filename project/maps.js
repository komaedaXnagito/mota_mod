...
{
	"1": {"cls":"animates","id":"yellowWall","canBreak":true,"trigger":null,"animate":1,"doorInfo":{"time":200,"openSound":"开关门","closeSound":"开关门","keys":{}}},
	"2": {"cls":"animates","id":"fakeWall","canBreak":true,"trigger":"openDoor","animate":1,"doorInfo":{"time":100,"openSound":"开关门","closeSound":"开关门","keys":{}}},
	"3": {"cls":"animates","id":"fakeWall2","canBreak":false,"trigger":"openDoor","animate":1,"doorInfo":{"time":200,"openSound":"开关门","closeSound":"开关门","keys":{}}},
	"4": {"cls":"animates","id":"star","noPass":true},
	"5": {"cls":"animates","id":"lava","noPass":true,"script":"if (core.hasItem('snow')) {\n\tcore.removeBlock(core.nextX(), core.nextY());\n\tvar moveStep = core.status.automaticRoute.autoStepRoutes;\n\tcore.status.automaticRoute.moveStepBeforeStop = core.status.automaticRoute.autoStepRoutes;\n}"},
	...
	"21": {"cls":"items","id":"jumpShoes"},
	"22": {"cls":"items","id":"symmetryPickaxe"},
	...
	"81": {"cls":"animates","id":"yellowWall","canBreak":true,"trigger":null,"animate":1,"doorInfo":{"time":200,"openSound":"开关门","closeSound":"开关门","keys":{}},"name":"墙壁"},
	"82": {"cls":"animates","id":"yellowWall","canBreak":true,"trigger":null,"animate":1,"doorInfo":{"time":200,"openSound":"开关门","closeSound":"开关门","keys":{}},"name":"墙壁"},
	"83": {"cls":"animates","id":"redDoor","trigger":"openDoor","animate":1,"doorInfo":{"time":120,"openSound":"开关门","closeSound":"开关门","keys":{"redKey":1}},"name":"红门"},
	"84": {"cls":"animates","id":"greenDoor","trigger":"openDoor","animate":1,"doorInfo":{"time":120,"openSound":"开关门","closeSound":"开关门","keys":{"greenKey":1}},"name":"绿门"},
	"85": {"cls":"animates","id":"specialDoor","trigger":"openDoor","animate":1,"doorInfo":{"time":120,"openSound":"开关门","closeSound":"开关门","keys":{"specialKey":1}},"name":"机关门"},
	"86": {"cls":"animates","id":"steelDoor","trigger":"openDoor","animate":1,"doorInfo":{"time":120,"openSound":"开关门","closeSound":"开关门","keys":{"steelKey":1}},"name":"铁门"},
	...
	"103": {"cls":"animates","id":"fire","canPass":true,"script":"function isValidPosition(x, y) {\n\treturn x >= 1 && x <= 11 && y >= 1 && y <= 11;\n}\n\nfor (var direction in core.utils.scan) {\n\tvar delta = core.utils.scan[direction];\n\tvar nx = x + delta.x,\n\t\tny = y + delta.y;\n\n\tif (!isValidPosition(nx, ny)) continue;\n\n\tvar nnx = x + 2 * delta.x,\n\t\tnny = y + 2 * delta.y;\n\n\tif (core.getBlockId(nx, ny) === 'redWizard') {\n\t\tcore.removeBlock(x, y);\n\t\tlet id = core.getBlockId(nnx, nny, null, true);\n\t\tif (!isValidPosition(nnx, nny)) continue;\n\t\tif (id === \"fire\" || id === null) {\n\t\t\tcore.removeBlock(nx, ny);\n\t\t\tcore.setBlock('redWizard', nnx, nny);\n\t\t\tif (id === \"fire\") {\n\t\t\t\tif (isValidPosition(nnx + delta.x, nny + delta.y) && core.getBlock(nnx + delta.x, nny + delta.y, null, true) === null) core.setBlock('fire', nnx + delta.x, nny + delta.y);\n\t\t\t\tcore.setBlock('fire', nx, ny);\n\t\t\t}\n\n\t\t}\n\t}\n}"},
	"104": {"cls":"animates","id":"switch"},
	"121": {"cls":"npcs","id":"oldman","trigger":"oldman","name":"老人"},
	"122": {"cls":"npcs","id":"trader","trigger":"trader","name":"商人"},
	"123": {"cls":"npcs","id":"thief","name":"小偷"},
	"124": {"cls":"npcs","id":"specialTrader","name":"商人"},
	"125": {"cls":"npcs","id":"magician"},
	"126": {"cls":"npcs","id":"womanMagician"},
	"127": {"cls":"npcs","id":"king","name":"作者"},
	"128": {"cls":"npcs","id":"child"},
	"129": {"cls":"npcs","id":"wood"},
	"130": {"cls":"npcs","id":"pinkShop"},
	"131": {"cls":"npcs","id":"blueShop"},
	"132": {"cls":"npcs","id":"princess","name":""},
	...
	"165": {"cls":"terrains","id":"light","trigger":null,"noPass":false,"outEvent":[{"type":"setBlock","number":"darkLight"}]},
	"166": {"cls":"terrains","id":"darkLight","noPass":true},
	"167": {"cls":"terrains","id":"ski","trigger":"ski","noPass":false},
	"168": {"cls":"terrains","id":"flower","noPass":true,"canPass":true,"event":[{"type":"switch","condition":"core.status.floorId","caseList":[{"case":"'MT33'","action":[{"type":"if","condition":"(status:direction==='right')","true":[{"type":"moveHero","steps":["right:1"]}],"false":[{"type":"playSound","name":"开关门"},{"type":"hide","remove":true,"destruct":true},{"type":"closeDoor","id":"yellowWall"}]}]},{"case":"'MT38'","action":[{"type":"if","condition":"(status:direction==='down')","true":[{"type":"moveHero","steps":["down:1"]}],"false":[{"type":"playSound","name":"开关门"},{"type":"hide","remove":true,"destruct":true},{"type":"closeDoor","id":"yellowWall"}]}]}]}],"outEvent":[{"type":"hide","remove":true,"destruct":true},{"type":"closeDoor","id":"yellowWall"}]},
	...
	"210": {"cls":"enemys","id":"skeletonSoldier"},
	...
	"330": {"cls":"animates","id":"unbreakableWall","noPass":"true","animate":1,"doorInfo":{"time":200,"openSound":"开关门","closeSound":"开关门","keys":{}}},
	"331": {"cls":"items","id":"centerFly3"},
	"332": {"cls":"enemys","id":"redWizardRepulse"}
}
