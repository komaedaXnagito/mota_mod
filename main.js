...
function main() {
	...
	this.version = '2.10.169'; // 游戏版本号；如果更改了游戏内容建议修改此version以免造成缓存问题。
    ...
    this.pureData = [
		...
		'weapons',
		'weaponRecipes',
		'backpackWeaponSynergy',
		'backpackUiCommon',
		'weaponCardRenderer',
		'randomStreams',
		'backpackWeaponSystem',
		'backpackSystem',
		'backpackBattleStatuses',
		'backpackBattleRules',
		'backpackBattleEstimateKernel',
		'backpackBattleCore',
		'backpackBattleEstimate',
		'backpackBattleFeedback',
		'backpackBattleUI',
		'backpackBattle',
		'backpackShop',
		'backpackCraft',
...
main.prototype.listen = function () {
    ...
    window.onresize = function () {
        try {
            if (!main.core || typeof main.core.resize !== 'function') return;
            main.core.resize();
        } catch (ee) {
            console.error(ee);
        }
