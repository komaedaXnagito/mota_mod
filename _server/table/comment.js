		...
		"items": {
			...
			"_data": {
				...
				"backpackWeaponId": {
					...
					"_string": true,
					"_docs": "背包武器ID",
					"_data": "关联 project/weapons.js 中的武器键。修改关联后请重新选中该物品。"
				},
				"weapon": {
					"_leaf": false,
					"_hide": function (args) { return args.vobj == null; },
					"_docs": "背包武器属性",
					"_data": {
						"id": {
							"_leaf": true,
						...
						"shape": {
							...
							"_lint": true,
							"_docs": "武器形状",
							"_data": "二维数组，1为占用格，0为空白。例如：[[1,1,1],[0,1,0]]"
						},
						"image": {
							"_leaf": true,
							"_type": "textarea",
						...
						"sourceName": {
							...
							"_string": true,
							"_docs": "素材原名",
							"_data": "导入数据或素材对应的原始名称"
						},
						"rarity": {
							"_leaf": true,
							"_type": "select",
							"_select": { "values": [null, 1, 2, 3, 4, 5] },
							"_docs": "稀有度",
							"_data": "数字稀有度，范围 1～5；null 表示未设置"
						},
						"minAttack": {
							"_leaf": true,
							"_type": "textarea",
							"_range": "thiseval == null || (typeof thiseval == 'number' && thiseval >= 0)",
							"_docs": "伤害下限",
							"_data": "命中时税前伤害的最小值；null 表示不主动攻击"
						},
						"maxAttack": {
							"_leaf": true,
							"_type": "textarea",
							"_range": "thiseval == null || (typeof thiseval == 'number' && thiseval >= 0)",
							"_docs": "伤害上限",
							"_data": "命中时税前伤害的最大值；null 表示不主动攻击"
						},
						"hitRate": {
							"_leaf": true,
							"_type": "textarea",
							"_range": "thiseval == null || (typeof thiseval == 'number' && thiseval >= 0 && thiseval <= 1)",
							"_docs": "命中率",
							"_data": "0～1，例如 0.75 表示 75%"
						},
						"attackInterval": {
							"_leaf": true,
							"_type": "textarea",
							"_range": "thiseval == null || (typeof thiseval == 'number' && thiseval > 0)",
							"_docs": "攻击间隔",
							"_data": "单位为回合；1 回合等于 100 Tick"
						},
						"ultimateGain": {
							"_leaf": true,
							"_type": "textarea",
							"_range": "thiseval == null || typeof thiseval == 'number'",
							"_docs": "奥义获取",
							"_data": "该武器普通攻击一次获得的基础奥义值；填负值表示该武器攻击需要消耗对应奥义（奥义不足时该武器无法攻击）"
						},
						"weaponTypes": {
							"_leaf": true,
							"_type": "popCheckboxSet",
							"_checkboxSet": {
								"key": ["剑", "刀", "斧", "枪", "拳", "短", "铳", "弓", "杖", "盾", "精灵", "饮料", "食物", "吉他", "乐器", "道具", "动物","召唤石"],
								"prefix": ["剑", "刀", "斧", "枪", "拳", "短", "铳", "弓", "杖", "盾", "精灵", "饮料", "食物", "吉他", "乐器", "道具", "动物","召唤石"]
							},
							"_docs": "武器类型",
							"_data": "可多选；用于布局联动和战斗规则筛选"
						},
						"synergyText": {
							"_leaf": true,
							"_type": "textarea",
